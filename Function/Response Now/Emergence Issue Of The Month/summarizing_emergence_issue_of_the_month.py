...
def get_mongo_connection():
    try:
        ...
        return db["emergence_issue_of_the_month_data"], db["emergence_issue_of_the_month"]
...
async def update_emerging_issues_data(data_collection, issue_collection):
    ...
    if updates:
        try:
            ...
            result = issue_collection.bulk_write([UpdateOne(x['filter'], x['update']) for x in updates], ordered=False)
...
if __name__ == "__main__":
    try:
        db_emergence_issue_of_the_month_data_collection, db_emergence_issue_of_the_month_collection = get_mongo_connection()

        asyncio.run(update_emerging_issues_data(db_emergence_issue_of_the_month_data_collection, db_emergence_issue_of_the_month_collection))
    except Exception as e:
