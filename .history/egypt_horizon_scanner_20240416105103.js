...
// Initialize routes
// Digital Avatar
egyptHorizonScanner.use('/digital-avater/dimension', require('./Route/Digital Avatar/dimensionRoutes'));
egyptHorizonScanner.use('/digital-avater/dimensions-definition',  require('./Route/Digital Avatar/dimensiondefinitionRoutes'));
egyptHorizonScanner.use('/digital-avater/issue-definition',  require('./Route/Digital Avatar/issuedefinitionRoutes'));
egyptHorizonScanner.use('/digital-avater/issue',  require('./Route/Digital Avatar/issueRoutes'));
egyptHorizonScanner.use('/digital-avater/issue-source-category',  require('./Route/Digital Avatar/issuesourcecategoryRoutes'));
