import projectsApiController from '../../../Controller/Response Now/Interventions/projects_api_controller.js';
const {
    getProjects, createProject, updateProjectByID, updateProjectByProjectName, deleteProjectByID, deleteProjectByProjectName, filterProjectsBasedOnTheme, filterProjectsBasedOnRCTheme, filterProjectsBasedOnEETheme, filterProjectsBasedOnDETheme, filterProjectsBasedOnIDTheme, filterProjectsBasedOnHDTheme, filterProjectsBasedOnPSTheme, filterProjectsBasedOnThemeandCity, filterProjectsBasedOnRCThemeandCity, filterProjectsBasedOnEEThemeandCity, filterProjectsBasedOnDEThemeandCity, filterProjectsBasedOnIDThemeandCity, filterProjectsBasedOnHDThemeandCity, filterProjectsBasedOnPSThemeandCity, countTotalDonationAmountBasedOnProjectName, countTotalDonationAmount
