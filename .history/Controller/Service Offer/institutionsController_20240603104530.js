...
export async function createAttendant(req, res) {
    const newAttendant = new institutionsSchema(req.body);
    try {
...
export async function getAllAttendants(req, res) {
    try {
        const institutions = await AttendantshModel.find();
...
export async function getAttendantById(req, res) {
    try {
        const institutions = await AttendantshModel.findById(req.params.id);
