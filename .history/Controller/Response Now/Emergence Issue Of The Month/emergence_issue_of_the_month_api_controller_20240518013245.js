...
import { fund, find, create, findByIdAndUpdate, findById, findOneAndUpdate, findOne, findByIdAndRemove, findOneAndRemove } from '../../../Model/Response Now/Emergence Issue Of The Month/emergence_issue_of_the_month_model.js';
...
// Functions
import { watchEmergingIssues, emergingIssueDataUpdate, emergingIssueComponentsCalculation } from '../../../Function/Response Now/Emergence Issue Of The Month/emergence_issue_of_month_functions';
...
const getEmergingIssues = asyncHandler(async (req, res) => {
  ...
  const emergingIssues = await fund({}).sort(commonSort);
