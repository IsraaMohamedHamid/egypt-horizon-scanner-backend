...
const updateGovernorateByID = ((req, res, next) => {
    ...
    governoratesModel.findByIdAndUpdate({ _id: req.params.id }, {$set:req.body}).then(function () {
        governoratesModel.findOne({ _id: req.params.id }).then(function (governorate) {
            res.send(governorate);
        });
    });
})
...
const updateGovernorateByGovernorateNameEN = ((req, res, next) => {
    //to access :id ---> req.params.id
    governoratesModel.findOneAndUpdate({ Governorate_Name_EN: req.params.governorateNameEN }, {$set:req.body}).then(function () {
        governoratesModel.findOne({ Governorate_Name_EN: req.params.governorateNameEN }).then(function (governorate) {
            res.send(governorate);
        });
    });
})
...
const deleteGovernorateByID = ((req, res, next) => {
    //to access :id ---> req.params.id
    governoratesModel.findByIdAndRemove({ _id: req.params.id }).then(function (governorate) {
        res.send(governorate);
    });
})
...
const deleteGovernorateByGovernorateNameEN = ((req, res, next) => {
    //to access :id ---> req.params.id
    governoratesModel.findOneAndRemove({ Governorate_Name_EN: req.params.governorateNameEN }).then(function (governorate) {
        res.send(governorate);
    });
})
