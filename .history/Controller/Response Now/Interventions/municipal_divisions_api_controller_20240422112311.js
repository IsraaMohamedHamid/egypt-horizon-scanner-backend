...
const getMunicipalDivisions = async (req, res, next) => {
  try {
    ...
    console.log(`${municipal_division.Municipal_Division_Name_EN}cts}`);
    ...
    const tasks = municipal_divisions.map(async (municipal_division) => {
      ...
      if (projects.length > 0) {
        ...
        console.log(`${municipal_division.Municipal_Division_Name_EN}: map: ${Object.values(map)}, Contains zero: ${Object.values(map).includes(0)}, no Projects: ${noProjects}, least Projects: ${leastProjects}, most Projects: ${mostProjects}`);
