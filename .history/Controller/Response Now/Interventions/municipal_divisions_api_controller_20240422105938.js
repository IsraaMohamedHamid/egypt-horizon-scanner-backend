  ...
  try {
    ...
    const tasks = municipalDivisions.map(async (municipalDivision) => {
      const projects = await projectsModel.find({
        Governorate_Name_EN: municipalDivision.Governorate_Name_EN
      });
      ...
      if (projects.length > 0) {
        ...
        console.log(`${municipalDivision.Governorate_Name_EN}: map: ${Object.values(map)}, Contains zero: ${Object.values(map).includes(0)}, no Projects: ${noProjects}, least Projects: ${leastProjects}, most Projects: ${mostProjects}`);
