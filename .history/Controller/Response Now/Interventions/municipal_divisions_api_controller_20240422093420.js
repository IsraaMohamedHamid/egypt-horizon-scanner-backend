  ...
  try {
    ...
    const tasks = municipalDivisions.map(async (municipalDivision) => {
      const projects = await projectsModel.find({
        MunicipalDivision_Name_EN: municipalDivision.MunicipalDivision_Name_EN
      });
      ...
      if (projects.length > 0) {
        ...
        console.log(`${municipalDivision.MunicipalDivision_Name_EN}: map: ${Object.values(map)}, Contains zero: ${Object.values(map).includes(0)}, no Projects: ${noProjects}, least Projects: ${leastProjects}, most Projects: ${mostProjects}`);
...
export const getMunicipalDivisions = getMunicipalDivisions;
export const createMunicipalDivision = createMunicipalDivision;
export const updateMunicipalDivisionByID = updateMunicipalDivisionByID;
export const updateMunicipalDivisionByMunicipalDivisionNameEN = updateMunicipalDivisionByMunicipalDivisionNameEN;
export const deleteMunicipalDivisionByID = deleteMunicipalDivisionByID;
export const deleteMunicipalDivisionByMunicipalDivisionNameEN = deleteMunicipalDivisionByMunicipalDivisionNameEN;
export const countMostInterventionTypePerMunicipalDivision = countMostInterventionTypePerMunicipalDivision;