...
export const getProgrammaticSimulation = asyncHandler(async (req, res) => {
...
// Get a list of all emerging issues from the DB
export const getProgrammaticSimulationWithUpdate = asyncHandler(async (req, res) => {
...
// watchProgrammaticSimulation().catch(console.error);
...
export default {
  getProgrammaticSimulation,
  getProgrammaticSimulationWithUpdate,
