...
import Dimension, { find, findById, findByIdAndUpdate, findByIdAndDelete } from '../../Model/Digital Avatar/dimension.js';
...
export async function getDimensionById(req, res) {
    try {
        const dimension = await findById(req.params.id);
