...
export async function getAllDimensionsWithUpdate = asyncHandler(async (req, res) => {
    console.log('START: Data retrieval and processing.');
  
    await DimensionsDataUpdate();
...
export default { createDimension, getAllDimensions, getAllDimensionsWithUpdate, getDimensionById, updateDimension, deleteDimension };
