...
export const localityModel= mongoose.model('interventions_locality_map', LocalitySchema, 'interventions_locality_map');

export default { LocalitySchema, localityModel };