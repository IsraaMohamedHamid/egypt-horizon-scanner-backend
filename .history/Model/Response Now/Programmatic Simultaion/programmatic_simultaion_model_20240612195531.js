...
export const ProgrammaticSimultaionSchema = new mongoose.Schema({
    _id: {
        typr: String
    },
    emergingIssue: {
...
export const EmergenceIssueOfTheMonthModel = mongoose.model('EmergenceIssueOfTheMonth', ProgrammaticSimultaionSchema, 'emergence_issue_of_the_month');

// Exporting the schema and model
export default  { ProgrammaticSimultaionSchema, EmergenceIssueOfTheMonthModel };