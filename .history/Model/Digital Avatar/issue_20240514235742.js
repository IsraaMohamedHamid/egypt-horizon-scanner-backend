...
const issueSchema = new mongoose.Schema({
  Dimension	
  Pillars	
  IssueCategory	IssuesTitle	IssuesMainSource 	SourceCategory	Link	DataAcquisitionProtocolDocumentFormat	PaidSubscription	WordDictionaryWordDictionary 	WordDictionarySearchTerms		OtherHelpfulSources												
