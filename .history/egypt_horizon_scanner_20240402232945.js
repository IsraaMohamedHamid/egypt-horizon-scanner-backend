...
const dimensionDefinitionRoutes =;
// Add the rest of your route imports here...

// Use routes
app.use('/dimensions', require('./routes/dimensionRoutes'));
app.use('/dimensions-definitions',  require('./routes/dimensionDefinitionRoutes'));
