...
////////// INTERVENTIONS
egyptHorizonScanner.use('/interventions', require('./Routes/Response Now/Interventions/projects'))
egyptHorizonScanner.use('/interventions', require('./Routes/Response Now/Interventions/localities'))
egyptHorizonScanner.use('/interventions', require('./Routes/Response Now/Interventions/states'))

// EMERGENCE ISSUE OF THE MONTH
egyptHorizonScanner.use('/emergence-issue-of-the-month', require('./Routes/Response Now/Emergence Issue Of The Month/emergence_issue_of_the_month'))
egyptHorizonScanner.use('/emergence-issue-of-the-month', require('./Routes/Response Now/Emergence Issue Of The Month/emergence_issue_of_the_month_data'))
