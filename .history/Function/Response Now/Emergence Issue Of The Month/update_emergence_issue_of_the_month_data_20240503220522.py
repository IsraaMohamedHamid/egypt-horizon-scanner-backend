...
from transformers import BertTokenizer, MobileBertTokenizer, TFAutoModelForSequenceClassification, AutoModel, AutoTokenizer, logging
...
if __name__ == "__main__":
    ...
    model_name = "huawei-noah/TinyBERT_General_4L_312D" # "voidful/albert_chinese_tiny"
    # Load model directly

    # model = AutoModel.from_pretrained("prajjwal1/bert-tiny")
    model = TFAutoModelForSequenceClassification.from_pretrained(model_name)
    tokenizer =  MobileBertTokenizer.from_pretrained(model_name) # TinyBertTokenizer.from_pretrained(model_name)
