...
const pythonExecutable = '/Function/Response Now/Emergence Issue Of The Month/update_emergence_issue_of_the_month_data.py'; // Replace 'path/to/python' with the actual path to your Python executable
...
const emergingIssueDataUpdate = async () => {
  try {
    ...
    const python = spawn('python', ['update_emergence_issue_of_the_month_data.py']);

    console.log(`START: Processing emerging issues.`);
    const pythonProcess = spawn('update_emergence_issue_of_the_month_data.py', ["__main__"])
