...
These changes incorporate the new sentiment analysis model and ensure that the sentiment analysis step in your data processing uses the Tiny BERT model instead of the VADER sentiment analyzer.