...
def update_emerging_issues_data(collection, model, tokenizer):
    ...
    for index, row in data.iterrows():
        ...
        update_dict = {'filter': {'_id': row['_id']}, 'update': {'$set': {'sentimentAnalysis': sentiment_label, 'weight': weight, 'score': probabilities.numpy()[0][predicted_class_index], 'language': lang}}}
