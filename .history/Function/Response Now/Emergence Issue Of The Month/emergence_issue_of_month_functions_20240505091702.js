...
const emergingIssueComponentsCalculation = async function () {
  try {
      ...
      for (const issue of uniqueIssues) {
          ...
          let { sources, sdgTargeted } = aggregation.length > 0 ? aggregation[0] : { sources: [], sdgTargets: [] };
          // console.log(sdgTargets);
          sdgTargeted = [...new Set([].concat(...sdgTargeted))]; // Flatten and deduplicate SDG targets
          // console.log(sdgTargeted);
