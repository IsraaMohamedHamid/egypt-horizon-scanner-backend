...
const pythonExecutable = '/Users/izzymohamed/Desktop/Horizon Scanner/egypt-horizon-scanner/Function/Response Now/Emergence Issue Of The Month/update_emergence_issue_of_the_month_data.py'; // Replace 'path/to/python' with the actual path to your Python executable

const emergingIssueDataUpdate = async () => {
  try {
    console.log(`START: Processing emerging issues.`);
    const pythonProcess = spawn(pythonExecutable, ['update_emergence_issue_of_the_month_data.py']);
