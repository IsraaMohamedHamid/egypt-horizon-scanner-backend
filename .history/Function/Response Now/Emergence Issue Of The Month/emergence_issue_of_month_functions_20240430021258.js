...
const pythonExecutable = 'Function/Response Now/Emergence Issue Of The Month/Emerging_Issues_of_the_Month_Model.ipynb'; // Replace 'path/to/python' with the actual path to your Python executable
