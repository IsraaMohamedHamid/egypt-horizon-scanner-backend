...
export const emergingIssueComponentsCalculation = async () => {
  try {
    ...
    for (const issue of emergingIssues) {
      ...
      updateData.averageWeight = issue.repetition ? issue.totalWeight ? (issue.totalWeight / issue.repetition) : 0 : issue.totalWeight ? (issue.totalWeight / issue.repetition) : 0; // Prevent NaN
