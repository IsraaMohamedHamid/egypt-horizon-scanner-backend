...
def get_mongo_connection():
    try:
        ...
        return db["emergence_issue_of_the_month_data"], db["emergence_issue_of_the_month_data"]
...
if __name__ == "__main__":
    try:
        ...
        asyncio.run(update_emerging_issues_data(db_emergence_issue_of_the_month_data_collection))
    except Exception as e:
