...
def sentiment_analysis(text, sentiModel, sentiTokenizer):
    ...
    predicted_class = sentiModel.config.id2label[predicted_class_index]
    
    return predicted_class, probabilities.numpy(), predicted_class_index

def perform_sentiment_analysis(description,  sentiModel, tokenizer):
    print("1")
