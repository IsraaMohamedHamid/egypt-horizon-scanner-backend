...
if __name__ == "__main__":
    ...
    emergence_issue_of_the_month_data_collection = db["emergence_issue_of_the_month_data"]
    emergence_issue_of_the_month_collection = db["emergence_issue_of_the_month"]
    
    print("Connected to MongoDB")
    print(emergence_issue_of_the_month_data_collection)
    
    # # Load data from MongoDB
    # data = pd.DataFrame(list(emergence_issue_of_the_month_data_collection.find()))
    ...
    # emergence_issue_of_the_month_collection.delete_many({})
    # emergence_issue_of_the_month_collection.insert_many(updated_data.to_dict(orient='records'))
