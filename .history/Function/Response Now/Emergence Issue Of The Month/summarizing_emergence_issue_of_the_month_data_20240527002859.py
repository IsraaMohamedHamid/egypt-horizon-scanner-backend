...
Python stderr: [nltk_data]   Package vader_lexicon is already up-to-date!

Python stderr: INFO:pymongo.serverSelection:{"message": "Waiting for suitable server to become available", "selector": "Primary()", "operation": "ping", "topologyDescription": "<TopologyDescription id: 6653c5407a3f1dcf18296d95, topology_type: ReplicaSetNoPrimary, servers: [<ServerDescription ('dbaas-db-5626135-44971bb4.mongo.ondigitalocean.com', 27017) server_type: Unknown, rtt: None>]>", "clientId": {"$oid": "6653c5407a3f1dcf18296d95"}, "remainingTimeMS": 29}

Python stderr: ERROR:root:No valid URLs found in the input data.
