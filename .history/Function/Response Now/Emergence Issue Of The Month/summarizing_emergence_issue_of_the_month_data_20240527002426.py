...
def process_url(item):
    try:
        ...
        sentiment_scores = perform_sentiment_analysis(summary)
        
        # Determine the sentiment label and score
        sentiment_label = max(sentiment_scores, key=sentiment_scores.get)
        sentiment_score = sentiment_scores[sentiment_label]
...
if __name__ == "__main__":
    ...
    results = process_urls(collection)
