...
def update_emerging_issues_data(collection, model, tokenizer):
    ...
    for index, row in data.iterrows():
        ...
        update_dict = {'filter': {'_id': row['_id']}, 'update': {'$set': {'sentimentAnalysis': sentiment_data['sentimentAnalysis'], 'sentimentWeight': sentiment_data['weight'], 'sentimentScore': sentiment_data['score'], 'language': sentiment_data['language']}}}
