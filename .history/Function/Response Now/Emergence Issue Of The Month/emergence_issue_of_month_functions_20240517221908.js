...
const db = MongoClient.db("egypt-horizon-scanner");
...
const uri = "mongodb://localhost:27017"; // Adjust this URI to your MongoDB server

// Create a new MongoClient
const client = new MongoClient(uri);

// Function to connect to the server and watch the collection
async function watchEmergingIssues() {
  try {
