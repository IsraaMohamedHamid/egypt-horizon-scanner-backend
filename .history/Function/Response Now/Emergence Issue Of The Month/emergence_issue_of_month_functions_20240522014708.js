...
export const emergingIssueDataUpdate = () => {
  return new Promise((resolve, reject) => {
    ...
    const pythonProcess = spawn('python3', [path.join(__dirname, 'Function', 'Response Now', 'Emergence Issue Of The Month', 'update_emergence_issue_of_the_month_data.py')]);
...
// Function to update the database with the latest data
