...
export const emergingIssueComponentsCalculation = async () => {
  try {
    ...
    for (const issue of uniqueIssues) {
      ...
      const sentimentAnalysisData = await countSentimentAnalysisData(repetition, issue, issueDocuments);

      // Concate the sentiment analysis data to the updateData
      updateData.sentimentAnalysisData = sentimentAnalysisData;
...
async function countSentimentAnalysisData(repetition, issue, issueDocuments){
