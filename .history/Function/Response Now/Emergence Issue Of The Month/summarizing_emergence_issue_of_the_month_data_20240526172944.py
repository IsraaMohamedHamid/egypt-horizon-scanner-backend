...
def update_emerging_issues_data(collection, model, tokenizer):
    ...
    for index, row in data.iterrows():
        ...
        update_dict = {'filter': {'_id': row['_id'], 'issueTitle': row['issueTitle'], 'emergingIssue': row["emergingIssue"], "sdgTargeted": row["sdgTargeted"], 'description': row['description']}, 'update': {'$set': results}}
