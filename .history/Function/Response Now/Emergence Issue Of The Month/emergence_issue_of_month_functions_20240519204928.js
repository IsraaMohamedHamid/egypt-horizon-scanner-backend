...
const uri = 'mongodb+srv://doadmin:wh37z621PJb850ai@dbaas-db-5626135-310aba91.mongo.ondigitalocean.com/egypt-horizon-scanner?replicaSet=dbaas-db-5626135&tls=true&authSource=admin';
...
const client = new MongoClient(uri, {
  ...
  tls: true,
  authSource: 'admin',
  serverSelectionTimeoutMS: 30000, // Wait 30 seconds before timeout
  connectTimeoutMS: 30000, // Wait 30 seconds before timeout on initial connection
});
