...
async def classify_and_extract_text(url):
    ...
    extracted_data = {
        "themes": themes,
        "main_objectives": extracted_info.get("Main objectives", ""),
        "main_outcomes": extracted_info.get("Main outcomes", ""),
        "problem_statement": extracted_info.get("Problem statement", ""),
