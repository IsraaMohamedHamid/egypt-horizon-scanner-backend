...
def parse_classification_and_extraction(response):
    ...
    for line in response.split("\n"):
        ...
        if line.startswith("Themes:"):
            ...
            sections[current_section] = remove_outer_quotes(line[len("Main objectives:"):].strip())
        elif line.startswith("Main outcomes:"):
            current_section = "Main outcomes"
            sections[current_section] = remove_outer_quotes(line[len("Main outcomes:"):].strip())
        elif line.startswith("Problem statement:"):
            current_section = "Problem statement"
            sections[current_section] = remove_outer_quotes(line[len("Problem statement:"):].strip())
        elif line.startswith("KPIs:"):
            current_section = "KPIs"
            sections[current_section] = remove_outer_quotes(line[len("KPIs:"):].strip())
