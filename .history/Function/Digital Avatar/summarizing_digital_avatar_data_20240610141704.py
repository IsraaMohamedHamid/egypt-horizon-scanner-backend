...
def get_mongo_connection():
    try:
        mongo_uri = 'mongodb+srv://doadmin:w94yB2Y17dWE8C63@dbaas-db-5626135-310aba9-mongo.ondigitalocean.com/egypt-horizon-scanner?tls=true&authSource=admin&replicaSet=dbaas-db-5626135'
...
# Function to get response from GPT--5-turbo
async def gpt_get(prompt, model="gpt--5-turbo"):
...
async def classify_and_extract_text(url):
    prompt = f"From the following Link {url}, classify the text into 5 themes and extract relevant information:\n" \
             ...
             "- Heatwaves reduce crops\n" \
             "2- High food prices\n" \
             "2- High number of doctors resign\n" \
             "2- Illegal informal employment\n" \
             "2- Infrastructure investments\n" \
             "2- Innovate financing tools for the energy sector\n" \
             "2- Lack of access to data, financial and technical support for the private sector\n" \
             "2- Lack of adequate funding to transition into green growth\n" \
             "2- Logistics in Africa: Status, Challenges & Routes for Egyptian Exports.\n" \
             "2- Losses of the national economy\n" \
             "2- Low efficiency of public investment\n" \
             "3- Modern and advanced infrastructure.\n" \
             "3- Natural gas and wheat supply\n" \
             "3- Natural gas decline and power cuts\n" \
             "3- Nile Dam\n" \
             "3- Overpopulation\n" \
             "3- Palestine, Sudan and EU policy\n" \
             "3- Plastic waste mismanagement in Egypt\n" \
             "3- Possible disconnects between the Government's macro policy aims for the green transition as well as the on-ground perceptions, concerns, and experiences of private sector actors\n" \
             "3- Problem of Illiteracy\n" \
             "3- Raising sea levels make Delta a vulnerable hotspot\n" \
             "4- Rising fuel prices\n" \
             "4- Rising sea levels\n" \
             "4- School system caution threatening losing control\n" \
             "4- Seasonal soil salinity and land degradation\n" \
             "4- Sovereign Green bond allocation\n" \
             "4- State of infrastructure in Egypt\n" \
             "4- Stigma and discrimination against HIV\n" \
             "4- Structural and cyclical determinants in Egypt for accessing to finance\n" \
             "4- Student density in classrooms\n" \
             "4- Sugar crisis\n" \
             "5- Sustainable finance\n" \
             "5- Targeting issues\n" \
             "5- The excessive bureaucracy and limited access to credit for the private investment\n" \
             "5- The insufficient marketing efforts for MICE tourism\n" \
             "5- Unemployment\n" \
             "5- Water management challenges\n" \
             "5- Water scarcity and food production\n" \
             "5- Water-Energy-Food nexus\n" \
             "5- Wheat shortage and high prices" \
             "Extract information:\n" \
             "- Main objectives\n" \
             "- Main outcomes\n" \
             "- Problem statement\n" \
...
async def update_emerging_issues_data(collection):
    ...
    input_cost = (total_input_tokens * -50) / 1_000_000
    output_cost = (total_output_tokens * -50) / 1_000_000
