...
export const DimensionsComponentsCalculation = async () => {
  try {
    ...
    const Dimensionss = uniqueIssueTitles.map(issueTitle => {
    ...
    for (const issue of Dimensionss) {
