...
async def process_url(session, item):
    try:
        ...
        result = {
            ...
            'MainObject': [analysis_results['extracted_info']["Main objectives"]],
            'MainOutcome': [analysis_results['extracted_info']["Main outcomes"]],
            'ProblemStatment': [analysis_results['extracted_info']["Problem statement"]],
            'KPIs': [analysis_results['extracted_info'].get(, "").strip()],
        }
