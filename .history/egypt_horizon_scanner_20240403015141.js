...
egyptHorizonScanner.use('/digital-avater/dimensions', require('./Route/Dimensions and Pillars/dimensionRoutes'));
egyptHorizonScanner.use('/digital-avater/dimensions-definitions',  require('./Route/Dimensions and Pillars/dimensiondefinitionRoutes'));
...
egyptHorizonScanner.use('/digital-avater/issue-routes',  require('./Route/Dimensions and Pillars/issueRoutes'));
egyptHorizonScanner.use('/digital-avater/issue-source-category-routes',  require('./Route/Dimensions and Pillars/'));
