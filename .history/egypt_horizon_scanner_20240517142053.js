...
const{installPythonLibraries} from './Function/python_functions');
...
const dbURI = 'mongodb+srv://doadmin:ODN8H5b74h39Bs21@dbaas-db-5626135-310aba91.mongo.ondigitalocean.com/egypt-horizon-scanner?replicaSet=dbaas-db-5626135&tls=true&authSource=admin';
...
mongoose.set('strictQuery', true); // To adopt the new behavior early
